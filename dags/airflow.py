...
with DAG(
    ...
    task_id='calculate_cluster_stats',
    python_callable=calculate_cluster_stats,
    op_args=['{{ ti.xcom_pull(task_ids="data_preprocessing_task") }}', 3],
    )

    # Set task dependencies
    load_data_task >> data_preprocessing_task >> build_save_model_task >> load_model_task >> calculate_stats_task
